...
if($_SERVER['REQUEST_METHOD']=='POST'){
 ...
 $stmt = $conn->prepare("INSERT INTO users (fname, lname, uname, email, password) VALUES (?)");
 
 //binding the parameter to statement 
 $stmt->bind_param("s", $fname, $lname, $uname, $email, $password);

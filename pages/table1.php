                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
										...
										<th class="center">Security Question</th>
										<th class="center">Answer</th>
										
										<th class="center">Date Sign Up</th>
										<th class="center">Time Sign Up</th>
                                    </tr>	
                                </thead>
                                <tbody>
								<?php
								...
								?>
                                    ...
                                    <tr class="odd gradeX">
										...
										<td class="center"><?php echo $row['question']?></td>
										<td class="center"><?php echo $row['answer']?></td>
                                        
										<td class="center"><?php echo $row['dateSignedUp']?></td>
										<td class="center"><?php echo $row['timeSignedUp']?></td>
                                    </tr><?php } ?>
                                </tbody>
                            </table>
                        </div>

                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td class="center"><?php echo $row['question1']?></td>
										<td class="center"><?php echo $row['question2']?></td>
										<td class="center"><?php echo $row['question3']?></td>
                                        <td class="center"><?php echo $row['question4']?></td>
										<td class="center"><?php echo $row['question5']?></td>
										<td class="center"><?php echo $row['apprate']?></td>
										<td class="center"><?php echo $row['feedback']?></td>
                                    </tr><?php } ?>

...
$itemnumrows = 0;}
	if($itemnumrows == 0)
	{
		...
		$updsql = "UPDATE orders SET total = '0' WHERE id = ". $_SESSION['SESS_ORDERNUM'] . ";";
...
echo'<i class="fa fa-shopping-cart fa-5x"></i><br>
	Your cart is empty.<br><br>
	<a class="cc" href="Shop.php">Continue Shopping</a>';
}
else {
...
?><a class="ccc" href= "ChangeQty.php?id=<?php echo $itemsrow['product_id'];?>">
										<i class="fa fa-minus-square fa-fw"></i></a>&nbsp;
									<?php echo $itemsrow['quantity']; ?>&nbsp;
									<a class="ccc" href="AddToCart.php?id=<?php echo $itemsrow['product_id']; ?>">

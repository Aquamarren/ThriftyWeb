...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	FROM reports WHERE ExpenseDate = CURDATE() AND (CategoryName = 'commute' || CategoryName = 'flight') AND UserID = '$idFriends'");	
	...
	WHERE ExpenseDate = CURDATE() AND (CategoryName = 'commute' || CategoryName = 'flight') AND UserID = '$idFriends' GROUP BY UserID
